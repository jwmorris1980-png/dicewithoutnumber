...
| `find map forest` or `/maplibrary forest` | Search only hand-reviewed, clearly playable, openly licensed RPG maps. The bot says no approved match instead of substituting generated, reference, or questionable maps. |
