...
| `find map forest` or `/maplibrary forest` | Post a visible map directly in Discord. Uses built-in maps first, then test-server-only openly licensed map search with creator and license credit. |
